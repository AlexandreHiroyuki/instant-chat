...
>
  ...
  <label
    class="input-group input-group-divider grid-cols-[auto_1fr_auto] text-lg"
  >
  ...
  <button on:click={linkStart} class="btn variant-filled text-lg w-full"
    >Create Instant User</button
  >
</div>

<div
  class="card p-4 w-72 shadow-xl variant-filled-error"
  data-popup="popupInvalid"
>
